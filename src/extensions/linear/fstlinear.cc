...
DEFINE_FST_string(epsilon_symbol, "<eps>", "Epsilon symbol");
DEFINE_FST_string(unknown_symbol, "<unk>", "Unknown word symbol");
DEFINE_FST_string(vocab, "", "Path to the vocabulary file");
DEFINE_FST_string(out, "", "Path to the output binary");
DEFINE_FST_string(save_isymbols, "", "Save input symbol table to file");
DEFINE_FST_string(save_fsymbols, "", "Save feature symbol table to file");
